...
selenium(geckover = NULL, iedrver = NULL, phantomver = NULL)
...
sourceFolder <- file.path("~/Documents","repos", "aiinabox", "bin", "133.0.6943.53")
...
main_port <- 4440L  # choose a port that is not used by parallel sessions
...
print(exportJson)
write(exportJson, "icd_10_code_links.json")